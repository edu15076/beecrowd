// https://www.beecrowd.com.br/judge/pt/problems/view/1841
...
int main() { _
    ull n; cin >> n;
    BinaryIndexedTree primeFactorsOfN = factorize(n);

    ull p;

    while (cin >> p) {
        primeFactorsOfN.add(p);
        cout << primeFactorsOfN.query(p - 1) << endl;
    }
